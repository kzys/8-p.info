...
ふりかえってみると、2000年からの10年は、ソフトウェアでは select(2) 代替の API とそれを使ったサーバーの普及、ハードウェアでは、x86 アーキテクチャの64ビット・マルチコア化と仮想化命令、そしてクラウドが登場する、なかなか面白い時代だったように思います。
...
ミクシィはもともと Apache を使っていたのもあり、当時もリバースプロキシとして Apache を使っている。
