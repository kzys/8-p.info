...
また、無料の Unix 系 OS を使って安価な x86 マシンを水平にならべることの有用性も、当時すでに認識されていたと思われる。たとえば、NASA の Linux クラスタ、Beowulf が発表されたカンファレンスは1995年の ICPP (International Conference on Parallel Processing) である。
