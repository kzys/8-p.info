...
また、Linux を使って安価な x86 マシンを水平にならべることの有用性も、すでに認識されていたと思われる。たとえば、NASA の Bowulf が発表されたカンファレンスは ICPP (International Conference on Parallel Processing) 1995 である。
