        ...
        <div id="quote">
            <div class="content">
                <blockquote>
                    ...
                    <footer><a href="https://www.sec.gov/Archives/edgar/data/1018724/000119312512161812/d329990dex991.htm">Jeff Bezos</a></footer>
                </blockquote>
            </div>
        </div>
        <div id="experiments">
            <div class="content">
                <nuxt-link to="/this-year/">This Year</nuxt-link>
            </div>
        </div>
    </div>
</template>
